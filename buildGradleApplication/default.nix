{
  ...
  package = stdenvNoCC.mkDerivation {
    ...
    buildPhase = ''
      ...
      # built the dam thing!
      gradle --dependency-verification off --offline --no-daemon --no-watch-fs --no-configuration-cache --no-build-cache --console=plain --no-scan -Porg.gradle.java.installations.auto-download=false --init-script ${./init.gradle.kts} ${buildTask}
